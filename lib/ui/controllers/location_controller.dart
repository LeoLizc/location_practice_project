...
import 'package:location_project/data/model/user_location.dart';
import 'package:location_project/domain/use_case/locator_service.dart';
...
class LocationController extends GetxController {
  ...
  Future<void> subscribeLocationUpdates() async {
    ...
    _positionStreamSubscription = service.locationStream.listen((event) {
      ...
      if (userLocation.value.latitude != 0 &&
          userLocation.value.longitude != 0) {
        _distance.value += service.calculateDistance(
